...
const Testimonials = () => {
  return (
    <div className='min-h-screen mb-10 py-8 ' >
      ...
      <div className='w-full flex xl:flex-row-reverse 2xl:flex-row-reverse flex-col flex-md-row items-center  justify-between' >
        <div className='w-1/6'>
          <Image src={Grabert} layout='responsive' />
        </div>
        <div className='w-2/3 mt-4 xl:mt-0'>
          <p>&#8220;
          When they said: We are the Google Analytics of the physical world-, they were not kidding! Thanks to Ariadne Maps, 
