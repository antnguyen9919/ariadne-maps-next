...
Leopoldstr. 21 <br/>
80802 München <br/>
datenschutzbeauftragter@datenschutzexperte.de<br/>

<b>Who we are</b> <br/>

Our website address is: https://ariadnemaps.com.<br/>
...
<b>Purpose and Legal Basis of the Processing of Personal Data</b> <br/>

Personal data required for the establishment, implementation or processing of our services is processed on the legal basis of Art. 6 para. 1 lit. b DSGVO. Insofar as we use external service providers in the context of order data processing, processing is based on the legal basis of Art. 28 DSGVO.<br/>

The personal data are collected, processed and used by us exclusively for the following purposes:<br/>

For contacting and related correspondence (Based on your consent)<br/>

For the processing of your request and for the further advice you may require (Based on your consent)<br/>

To improve our website (Based on your consent)<br/>

To ensure that our website is presented to you in the most effective and interesting manner possible (for example, by anonymized evaluation) (Due to Legitimate Interests)<br/>

For the technical realization of our offers (Due to Legitimate Interests)<br/>
<b>
Collected and processed personal data</b> <br/>

We collect and process your personal data only if you voluntarily, under your knowledge, make it available, e.g. by filling out forms or sending e-mails. In the context of the available forms, these are first of all the following data:<br/>

<b>General contact details:</b> <br/>
...
The personal data you provide and its contents remain solely with us and our affiliates. We will store and process your data only for the purposes stated in 5. Any use exceeding the stated purpose requires your express consent. The same applies to the transmission and transfer of your data to third parties.<br/>

<b>Cookies</b> <br/>

<b>Use of Cookies</b> <br/>

On our website, information is collected and stored by the use of so-called browser cookies.<br/>

<b>What are Cookies?</b> <br/>

These are small text files that are stored on your device and that store certain settings and data in order to share it with our system through your browser. A cookie usually contains the name of the domain from which the cookie data was sent, as well as information about the age of the cookie and an alphanumeric identifier.<br/>
...
Articles on this site may include embedded content (e.g. videos, images, articles, etc.) from various websites such as Youtube. Embedded content from other websites behaves in the exact same way as if the visitor has visited the other website.
<br/>
...
When you visit our websites, we use third-party services for hosting, analytics, advertising, customer support, content acceleration, and other promotional purposes, including Google (Analytics, Ad Services, Tag Manager), reCAPTCHA, LinkedIn Insight Tag, Leadfeeder and others. We use information about which web pages you access along with information you provide to improve the content of our web pages and the quality of our service. We use your contact information for marketing and sales purposes.<br/>
...
The information we collect is not shared with or sold to other organizations for commercial purposes, except to provide products or services you&rsquo;ve requested, when we have your permission, or under the circumstances described in this policy.<br/>
