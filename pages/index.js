...
/>
      ...
      <main className={styles.main}>
        <div className={styles.section1} id = "screens">
          ...
          <div className={styles.section1screens}>
              ...
              <p className='text-center text-red-500' ><button onClick={openModal} ><AddCircleOutlineIcon/>&nbsp;Enlarge</button></p>
      ...
      >
        <div className="flex flex-col items-center justify-center content-center align-center " >
            <div className='w-5/6' >
            <img src="/Photos/enlarge/eAnalytics.png" width="100%"  />
            </div>
          ...
          <div className="flex flex-col items-center justify-center content-center align-center " >
            ...
            <img src="/Photos/enlarge/ERP.png" width="100%" height="100%"/>
            </div>
