...
<div className={videoOpen?" overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full":"hidden"}>
    <div className="relative p-4 w-full max-w-2xl h-full md:h-auto">
        ...
        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div className="flex justify-between items-start p-5 rounded-t border-b dark:border-gray-600">
                ...
                <button onClick={()=>setVideoOpen(false)} type="button" className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white">
